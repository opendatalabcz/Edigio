...
class AdvertisementResponseEmailServiceImpl(
    ...
    private fun createAdvertisementCreatedAdvertiserMessage(data : AdvertisementResponseAvailableAdvertiserMessageData) : String {
    ...
    override fun sendAdvertisementResponseAvailableToAdvertiser(data : AdvertisementResponseAvailableAdvertiserMessageData) {
